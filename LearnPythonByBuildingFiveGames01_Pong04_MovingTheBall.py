...
ball.shape("square")  # Turtle Class has build in shapes, default (20x20)
...
# Ball Movement
ball.dx = 8  # Create ball attribute to hold, ball x change (d for delta or change & x) speed
ball.dy = -8  # Create ball attribute to hold, ball y change (d for delta or change & y) speed
