...
pen_speed.goto(230, heading_top - 5)
...
pen_again = turtle.Turtle()
pen_again.speed(0)
pen_again.color("white")
pen_again.penup()
pen_again.hideturtle()
pen_again.goto(0, heading_3)
...
# Players Side B
    ...
    if ball.score_win in (score_a, score_b):
        pen_again.write(f"( --- Press Space Bar to play again! --- )\n\n     *** L/R:+/- # of games to win ***",
        ...
        os.system("afplay programstart.mp3&")
        time.sleep(3)
        pen_win_heading.clear()
        pen_again.clear()
